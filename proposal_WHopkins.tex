...
\begin{figure}[!htbp]
  \centering
  \subfigure[FastSim top quark ID efficiency.]{\includegraphics[width=0.47\textwidth]{figures/af2TagEfficiency.pdf}}
  \subfigure[FullSim top quark ID efficiency.]{\includegraphics[width=0.47\textwidth]{figures/fullSimTagEfficiency.pdf}}
...
% The following needs to answer the "why me?" question a bit better.
...
\begin{figure}[!htbp]
  \centering
  \subfigure[NN cannot discriminate between BSM models which are different from SM: cluster the BSM models]{
    \includegraphics[width=0.30\textwidth]{figures/nnCluster_cluster.pdf}
  }\hspace{3mm}
  \subfigure[NN can discriminate the BSM model pairs and SM: keep BSM models and use for next iteration of clustering]{
    \includegraphics[width=0.30\textwidth]{figures/nnCluster_nocluster.pdf}
  }\hspace{3mm}
  \subfigure[One or both BSM models are background-like: discard BSM model]{
    \includegraphics[width=0.30\textwidth]{figures/nnCluster_discard.pdf}
  }
...
% Figure~\ref{fig:rangeCutCartoon} shows a simplified view of the effect of range cuts.
...
\begin{figure}[!htbp]
  \centering
  \subfigure[Particle shower with no production cuts.]{\includegraphics[width=.445\textwidth]{figures/noRangeCutEventDisplay.pdf}}
  \subfigure[Particle shower with 100 mm production cuts.]{\includegraphics[width=.45\textwidth]{figures/rangeCutEventDisplay_100mm.pdf}}
...
% \begin{figure}[!htpb]
%   \centering
%   \subfigure[Development of particle shower without production cut.]{\includegraphics[width=.45\textwidth]{figures/noRangeCutCartoon.pdf}}
%   \subfigure[Development of particle shower with production cut.]{\includegraphics[width=.45\textwidth]{figures/rangeCutCartoon.pdf}}
%   \caption{A simplified view of the effect of production cuts with low-energy (with a short range) secondary/tertiary particles propagating through a detector (a) and with the primary particle having its energy deposited along its trajectory if its secondary particles are expected to travel less than the specified range (b). Each orange dot corresponds to a geometric calculation needed to propagate the particle through the volume. Applying production cuts will limit the number of low-energy particles that require these calculations. The production cuts will also alter the EM shower but this could be corrected with an ML algorithm.}
%   \label{fig:rangeCutCartoon}
% \end{figure}
...
\subsection{Projected outcomes} % : More detailed description?
...
% Timetable consideration, using https://lhc-commissioning.web.cern.ch/schedule/HL-LHC-plots.htm as input
...
% The proposed work also has the potential of making the PI and ANL a leader in ML algorithm development within ATLAS, especially for BSM search strategies and detector simulations.
